    ...
    return (
        <div className="bg-[#08070d]">
            ...
            <section className="relative min-h-[100svh] overflow-hidden">
                <Image
                    src="/volume1.png"
                    alt="Eves Against The Odds Volume 1"
                    fill
                    priority
                ...
                <div className="relative z-10 flex min-h-[100svh] items-center">
                    <div className="max-w-7xl px-6 md:px-16 lg:px-24">
                        ...
                        <h1 className="font-bold uppercase tracking-[-0.04em] leading-none text-[48px] md:text-[72px] lg:text-[96px] bg-gradient-to-b from-pink-300 via-pink-500 to-fuchsia-600 bg-clip-text text-transparent">
                            THE ODDS
                        </h1>
                        ...
                        <div className="mt-10 flex flex-wrap gap-4">
                            <button className="rounded-full bg-[#b99160] px-8 py-3 font-semibold text-black transition hover:scale-105">
                                Get Your Copy
                            </button>

                            <button className="rounded-full border border-white/20 px-8 py-3 text-white transition hover:bg-white/10">
                                Explore Stories
                            </button>
                        </div>
                    </div>
            ...
            <section className="relative py-32 overflow-hidden bg-[#08070d]">
                {/* Background Glow */}
                <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-fuchsia-600/20 blur-[180px]" />
        ...
        ">
                ...
                ">
                            ...
                            drop-shadow-[0_30px_60px_rgba(236,72,153,0.4)]
                        "
                                />
                            </div>
                        </div>
                ...
                ">
                    ...
                    max-w-xl
                ">
                                Volume II brings together another powerful collection
